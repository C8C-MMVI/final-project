export default function LeftPanel({ logoSrc = '/images/Logo.png' }) {
  return (
    ...
    >
      ...
      >
        Streamline Your{' '}
        <span className="text-teal">Repair Business</span>
      </p>
      ...
      >
        Comprehensive management solution for cellphone repair shops and accessories retailers.
        Track repairs, manage inventory, and grow your business—all in one powerful platform.
      </p>
    </div>
  );
}